...
public:
    ...
    class StelAppGraphicsWidget* getMainSkyItem() { return mainSkyItem; }

    class StelQmlGui* getQmlGui() const { return qmlGui; }
...
public slots:
    ...
    float getBaseMinFps() { return baseMinFps; }
